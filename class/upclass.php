                ...
                <div class="card-body">
                    <div class="col mb-0" style="display: none;">
                        ...
                        <div class="input-group input-code">
                            ...
                            <input type="text" required name="codeup" id="codeup" class="form-control" placeholder="XXXXX" aria-label="numreg" aria-describedby="basic-icon-default-numreg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-0">
                    ...
                    <div class="row">
                        <div class="col mb-0">
                            ...
                            <div class="input-group input-code">
                                ...
                                <input type="number" required name="CAup" id="CAup" class="form-control" min="0" placeholder="XXXXX" aria-label="CA" aria-describedby="basic-icon-default-CA">
                            </div>
                        </div>
                        <div class="col mb-0">
                            ...
                            <div class="input-group input-code">
                                <span id="basic-icon-code" class="input-group-text">>=</span>
                                <input type="number" min="0" required name="CSup" id="CSup" class="form-control" placeholder="XXXXX" aria-label="CA" aria-describedby="basic-icon-default-CA">
                            </div>
                        </div>
                    </div>
                    <div class="col mb-0">
                        ...
                        <div class="input-group input-nbing">
                            ...
                            <input type="number" min="0" required name="nbingup" id="nbingup" class="form-control" placeholder="XXXXX" aria-label="nbing" aria-describedby="basic-icon-default-nbing">
                        </div>
                    </div>
                    <div class="col mb-0">
                        ...
                        <div class="input-group input-nbing">
                            <span id="basic-icon-code" class="input-group-text"><i class='bx bx-user-circle'></i></span>
                            <input type="number" required name="nbtup" id="nbtup" class="form-control" min="0" placeholder="XXXXX" aria-label="nbt" aria-describedby="basic-icon-default-nbing">
                        </div>
                    </div>
                    <div class="col mb-0">
                        ...
                        <div class="input-group input-nbing">
                            <span id="basic-icon-code" class="input-group-text"><i class='bx bx-user-circle'></i></span>
                            <input type="number" required name="nmeup" id="nmeup" class="form-control" min="0" placeholder="XXXXX" aria-label="nme" aria-describedby="basic-icon-default-nbing">
                        </div>
                    </div>
                </div>
