                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card row g-2">
                            <div class="input-group input-group-merge col mb-0" style="margin-bottom: -5px !important;">
                                ...
                                <input id="search" type="text" class="form-control" placeholder="Recherche par nom | code ville" aria-label="Search..." aria-describedby="basic-addon-search31">
                            </div>
                                        ...
                                        <div class="modal-content container-xxl">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col mb-0">
                                                        ...
                                                        <div class="input-group input-code">
                                                            ...
                                                            <input type="text" required name="ville" id="basic-icon-code" class="form-control" placeholder="XXXXX" aria-label="numreg" aria-describedby="basic-icon-default-numreg">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-0">
                                                ...
                                                <div class="col mb-0" style="margin-top: 9px;">
                                                    <button type="submit" name="Addville" class="btn btn-primary">ajouter</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
