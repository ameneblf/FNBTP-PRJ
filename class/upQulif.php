                ...
                <div class="card-body">
                    <div class="col mb-0" style="display: none;">
                        ...
                        <div class="input-group input-code">
                            ...
                            <input type="text" required name="upcode" id="upcode" class="form-control" placeholder="XXXXX"
                    ...
                    <div class="col mb-0">
                        ...
                        <div class="input-group input-code">
                            ...
                            <input type="text" required name="nomup" id="nomup" class="form-control" placeholder="XXXXX"
                                aria-label="numreg" aria-describedby="basic-icon-default-numreg">
                        </div>
                    </div>
                    <div class="col mb-0">
                    ...
                    <div class="col mb-0" style="margin-top: 9px;">
                        <button type="button" name="update" id="upbtn" class="btn btn-primary">éditer</button>
                    </div>
                </div>
        </form>
    </div>
