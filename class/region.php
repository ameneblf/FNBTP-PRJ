                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-0" style="display: none;">
                                                        ...
                                                        <div class="input-group input-code">
                                                            ...
                                                            ?>
                                                            <input type="number" required value="<?php echo $idinsert[0] + 1; ?>" name="idregion" id="basic-icon-code" class="form-control" placeholder="XXXXX" aria-label="numreg" aria-describedby="basic-icon-default-numreg">
                                                        </div>
                                                    </div>
                                                    <div class="col mb-0">
                                                        ...
                                                        <div class="input-group input-code">
                                                            ...
                                                            <input type="text" required name="region" id="basic-icon-code" class="form-control" placeholder="XXXXX" aria-label="numreg" aria-describedby="basic-icon-default-numreg">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col mb-0" style="margin-top: 9px;">
                                                    <button type="submit" name="addregion" class="btn btn-primary">ajouter</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
