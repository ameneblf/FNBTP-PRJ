                                    ...
                                    <form action="secteurs.php" method="post">
                                        <div class="modal-content container-xxl">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col mb-0">
                                                        ...
                                                        <div class="input-group input-group-phone">
                                                            ...
                                                            <select required name="categ" id="categ" class="form-select">
                                                                <option value="0 ">Sélection par défaut</option>
                                                                <?php
                                                ...
                                                <br>
                                                <div class="col mb-0">
                                                    <input class="form-check-input" type="checkbox" name="capital" id="inlineCheckbox1" value="1">
                                                ...
                                                <div class="col mb-0" style="margin-top: 12px;">
                                                    <button type="submit" name="Addsect" class="btn btn-primary">ajouter</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
